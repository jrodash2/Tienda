...
urlpatterns = [
    ...
    path('pos/api/productos/', views.pos_api_productos, name='pos_api_productos'),
    path('pos/api/clientes/buscar/', views.pos_api_clientes_buscar, name='pos_api_clientes_buscar'),
    path('pos/api/clientes/crear/', views.pos_api_clientes_crear, name='pos_api_clientes_crear'),
    path('pos/api/ventas/crear/', views.pos_api_ventas_crear, name='pos_api_ventas_crear'),
    path('pos/api/cotizaciones/crear/', views.pos_crear_cotizacion_api, name='pos_crear_cotizacion_api'),
    path('pos/venta/<int:venta_id>/comprobante/', views.pos_comprobante, name='pos_comprobante'),
    path('pos/venta/<int:venta_id>/comprobante/pdf/', views.pos_comprobante_pdf, name='pos_comprobante_pdf'),
    path('pos/venta/<int:pk>/agregar-pago/', views.agregar_pago_pos, name='pos_agregar_pago'),
    path('pos/venta/<int:pk>/anular/', views.anular_venta_pos, name='pos_anular_venta'),
    path('pos/clientes/', views.pos_clientes_lista, name='pos_clientes_lista'),
    path('pos/cotizaciones/', views.pos_cotizaciones_lista, name='pos_cotizaciones_lista'),
    path('pos/cotizaciones/<int:cotizacion_id>/', views.pos_cotizacion_detalle, name='pos_cotizacion_detalle'),
    path('pos/cotizaciones/<int:cotizacion_id>/comprobante/', views.pos_cotizacion_comprobante, name='pos_cotizacion_comprobante'),
    path('pos/cotizaciones/<int:cotizacion_id>/comprobante/pdf/', views.pos_cotizacion_pdf, name='pos_cotizacion_pdf'),
    path('pos/cotizaciones/<int:cotizacion_id>/convertir-venta/', views.pos_cotizacion_convertir_venta, name='pos_cotizacion_convertir_venta'),
    path('pos/cotizaciones/<int:cotizacion_id>/anular/', views.pos_cotizacion_anular, name='pos_cotizacion_anular'),
